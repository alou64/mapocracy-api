...
Revision ID: 95d5bdc336b4
Revises: 810ce10ab796
Create Date: 2022-03-19 19:40:16.889334
...
revision = '95d5bdc336b4'
down_revision = '810ce10ab796'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('poll', sa.Column('center', sa.String(), nullable=True))
    op.add_column('poll', sa.Column('restriction', sa.String(), nullable=True))
    op.add_column('poll', sa.Column('visibility', sa.String(), nullable=True))
